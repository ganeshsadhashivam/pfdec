...
const TYPES = {
  ...
  //---------------------deliveryDetails----------------------------------
  DeliveryDetailsRepository: Symbol.for("DeliveryDetailsRepository"),
  DeliveryDetailsService: Symbol.for("DeliveryDetailsService"),
  DeliveryDetailsController: Symbol.for("DeliveryDetailsController"),
};
