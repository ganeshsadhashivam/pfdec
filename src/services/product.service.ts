...
import { ProductSubcategoryService } from "./product_subcategory";
...
export class ProductService {
  ...
  constructor(
    ...
    @inject(TYPES.ProductSubcategoryService) private productSubcategoryService: ProductSubcategoryService,
    @inject(TYPES.UOMService) private uomService: UOMService,
    @inject(TYPES.ProductCategoryService) private productCategoryService: ProductCategoryService,
  ...
  async create(dto: ProductInput): Promise<Product> {
    ...
    const subcategory = subcategoryId ? await this.productSubcategoryService.getById(subcategoryId) : undefined;
    ...
    const classification = classificationId
      ...
      : undefined;
    const category = categoryId ? await this.productCategoryService.getById(categoryId) : undefined;
